...
namespace FormContable.Compras.RetencionIslr
{
    public partial class VisualizarDocumento : Form
    {
        ...
        BindingSource bs;
        BindingList<OOB.Compra.RetencionIslr.Detalle> Detalles;
        ...
        {
            var r01 = Globals.MyData.Compra_RetencionIslr_GetById(doc);
            ...
            Detalles = new BindingList<OOB.Compra.RetencionIslr.Detalle>(FichaRetencion.Detalles);
